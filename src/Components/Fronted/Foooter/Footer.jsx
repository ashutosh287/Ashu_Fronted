      ...
      <div className="mt-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-900 p-4 sm:p-6 rounded-xl text-start text-white">
            <h2 className="text-xl sm:text-xl font-semibold text-purple-500 hover:text-green-500">
             Packzo – Your Online Marketplace
            </h2>
            <p className="mt-2 text-gray-300 text-[17px] sm:text-base">
            ...
            <h3 className="mt-4 font-medium text-purple-400 text-lgsm:text-base">
          ...
          <div className="bg-gray-900 p-4 sm:p-6 rounded-xl shadow-lg transition duration-300 hover:shadow-2xl">
            <h3 className="text-xl sm:text-lg font-semibold flex items-center text-white">
            ...
            <p className="mt-3 text-gray-300 animate-fade-in text-[17px] sm:text-base">
          ...
          <div className="bg-gray-900 p-4 sm:p-6 rounded-xl">
            <h3 className="text-xl sm:text-lg font-semibold hover:text-green-500 text-purple-500">
            ...
            <div className="mt-3 grid grid-cols-2 gap-4 text-gray-400">
              {/* Column 1: Company */}
              <div>
                <h4 className="text-white font-medium hover:text-green-500 text-[17px] sm:text-base">Company</h4>
                <ul className="mt-2 space-y-1">
                  <li><Link to="/our-story" className="hover:text-white transition text-[15px] sm:text-base">Our Story</Link></li>
                  <li><Link to="/contact" className="hover:text-white transition text-[15px] sm:text-base">Contact Us</Link></li>
                  <li><Link to="/about" className="hover:text-white transition text-[15px] sm:text-base">About Us</Link></li>
                </ul>
              </div>

              {/* Column 2: Help */}
              <div>
                <h4 className="text-white font-medium hover:text-green-500 text-[17px] sm:text-base">Let us help you</h4>
                <ul className="mt-2 space-y-1">
                  <li><Link to="/help" className="hover:text-white transition text-[15px] sm:text-base">Help Center</Link></li>
                  <li><Link to="/become-a-seller" className="hover:text-white transition text-[15px] sm:text-base">Become a Seller</Link></li>
                  <li><Link to="#" onClick={handleLanguageClick} className="hover:text-white transition text-[15px] sm:text-base">Language</Link></li>
                </ul>
              </div>

              {/* Row 2: Legal (full width) */}
              <div className="col-span-2">
                <h4 className="text-white font-medium hover:text-green-500 text-[17px] sm:text-base">Legal</h4>
                <ul className="mt-2 space-y-1">
                  <li><Link to="/privacy-policy" className="hover:text-white transition text-[15px] sm:text-base">Privacy Policy</Link></li>
                  <li><Link to="/community-rules" className="hover:text-white transition text-[15px] sm:text-base">Community Rules</Link></li>
                </ul>
              </div>
            </div>
          </div>
